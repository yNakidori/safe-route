                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="text-gray-900 py-2">{userProfile.displayName || 'Não informado'}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="text-gray-900 py-2">{userProfile.phone || 'Não informado'}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="text-gray-900 py-2">{userProfile.address || 'Não informado'}</p>
                                    )}
                                </div>
                            </div>
                        </div>
                                    ...
                                    contacts.slice(0, 5).map((contact, index) => (
                                        <div key={index} className="flex items-center p-3 bg-gray-50 rounded-lg">
                                            ...
                                            <div className="flex-1">
                                                <p className="font-medium text-gray-900">{contact.name || 'Contato'}</p>
                                                <p className="text-sm text-gray-600">{contact.phone || contact.email}</p>
                                            </div>
                                        </div>
                                    ))
                                ) : (
                                    <p className="text-gray-500 text-center py-8">Nenhum contato adicionado</p>
                                )}
                                ...
                                {routes.length > 0 ? (
                                    routes.slice(0, 6).map((route, index) => (
                                        <div key={index} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                                            ...
                                            <div className="text-sm text-gray-600">
                                                <p className="mb-1">🚀 {route.origin || 'Local de origem'}</p>
                                                <p className="mb-1">🎯 {route.destination || 'Local de destino'}</p>
                                                <p className="text-xs text-gray-500">
                                                    {route.date ? new Date(route.date).toLocaleDateString() : 'Data não informada'}
                                                </p>
                                            </div>
                                        </div>
                                    ))
                                    ...
                                    <div className="col-span-full">
                                        <div className="text-center py-12">
                                            ...
                                            <p className="text-gray-500 mb-4">Nenhuma rota encontrada</p>
